...
- **Dataset**: Imagenette (10-class ImageNet subset, 9469 train images)

## Default Hyperparameters
- blr: 5e-5 (scaled by batch_size/256)
- batch_size: 256 (calibrated for 128px on RTX 3090)
- warmup_epochs: 1
...
## Training Setup (128px, bs=256)
- img_size: 128 → 64 tokens (8x8 patches)
- batch_size: 256 (single GPU)
- class_num: 10 (Imagenette)
- ~32s per epoch, ~21.9GB VRAM (89% utilization)
- 8 epochs per experiment (~4.5 min)
- 36 iterations per epoch

## VRAM Calibration
- bs=256 @ 128px: 21.9GB (89%) — selected
- bs=320 @ 128px: OOM
