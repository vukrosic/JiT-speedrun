...
**Active baseline:** arch_bottleneck512 | loss: 0.1138 | 2026-03-17
**Noise floor:** std=0.0017 | **Min detectable improvement:** 0.0026 | **Must beat:** 0.1112

## Historical Progression

| Rank | Exp ID | Metric | Δ vs Previous | % Improvement | Key Change | Batch |
|------|--------|--------|---------------|---------------|------------|-------|
| 5 | arch_bottleneck512 | 0.1138 | -0.0028 | 2.4% | bottleneck_dim=512 (4x default) | 8 |
